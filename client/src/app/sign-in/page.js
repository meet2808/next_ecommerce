        ...
        <>
            <>
                <div className="my-10 mx-auto w-[400px] px-[5px] py-[10px]">
                    ...
                    <button className="bg-slate-900 h-12 w-full text-white uppercase border hover:text-slate-900 hover:border-slate-900 hover:bg-transparent hover:ease-in-out hover:delay-10">Sign In</button>
                    <span className="text-neutral-600 text-[15px]">Don't have an account?<Link href="/sign-in">Sign Up</Link></span>
                </div>
            </>
        </>
    )
